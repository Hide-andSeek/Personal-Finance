...
<body>
    <nav id="navbar">
        ...
        <ul>
            ...
            <li class="navlink-active"><a class="nav-link" href="../pages/income_statement.php"><i class="fas fa-file-text"></i> Income Statement</a></li>
